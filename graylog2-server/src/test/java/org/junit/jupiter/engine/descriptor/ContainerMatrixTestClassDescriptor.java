...
public class ContainerMatrixTestClassDescriptor extends ClassBasedTestDescriptor {
    ...
    public ContainerMatrixTestClassDescriptor(TestDescriptor parent, Class<?> testClass, JupiterConfiguration configuration, @Nullable SearchVersion esVersion, @Nullable MongodbServer mongoVersion, List<URL> mongoFixtures, boolean preImportLicense) {
        super(
    ...
    public ContainerMatrixTestClassDescriptor(TestDescriptor parent, Class<?> testClass, JupiterConfiguration configuration, List<URL> mongoFixtures, boolean preImportLicense) {
